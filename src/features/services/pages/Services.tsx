    ...
    <div className="w-full min-h-screen ">
      ...
      <section className="w-full ">
        <div className="relative flex justify-center items-center -top-10">
          <nav className="bg-white h-20 rounded-full flex justify-center items-center">
            <ul className="flex flex-row justify-center items-center">
              {subServices.map((item) => (
                <li key={item.path} className="px-10">
                  {item.title}
                </li>
              ))}
            </ul>
        ...
        <div className="w-full max-w-7xl mx-auto pb-10">
          <div className="grid grid-cols-2">
            <div className="flex flex-col justify-center p-5">
              <h3 className="text-4xl font-bold">Servicio 1</h3>
              <p className="text-lg text-bg-300 mt-5">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Repellendus praesentium quas vero labore laborum quasi autem
                officia, dolor aperiam eligendi corporis aut eaque eveniet
                voluptas reiciendis recusandae, veniam culpa nihil.
              </p>
              <button className="mt-15 bg-primary-100 text-white w-40 px-5 py-3 rounded-lg  hover:bg-primary-100/80 transition-colors">
                Ver más
              </button>
            </div>
