...
export class BlogService {
    ...
    const updatedPosts = posts.map(post => 
      post.id === updatedPost.id 
        ? { 
            ...
            publishedAt: updatedPost.isPublished && !post.isPublished 
  ...
  static createBlogCategory(categoryData: Omit<BlogCategory, 'id'>): BlogCategory {
    ...
    return [
      {
        ...
        excerpt: 'Este es el primer post de nuestro blog corporativo donde compartiremos noticias y novedades.',
