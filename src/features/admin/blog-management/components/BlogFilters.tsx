  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-medium text-bg-100 flex items-center">
      ...
      {hasActiveFilters && (
        <div className="mt-4 pt-4 border-t border-white-100">
          <p className="text-sm text-bg-200 mb-2">Filtros activos:</p>
