...
import type { MultimediaFilters, CreateMultimediaRequest } from '../types/multimediaTypes';
...
const MultimediaManagement: React.FC = () => {
  ...
  const handleFiltersChange = useCallback((newFilters: MultimediaFilters) => {
  ...
  const handleUpload = useCallback(async (fileRequests: CreateMultimediaRequest[]) => {
